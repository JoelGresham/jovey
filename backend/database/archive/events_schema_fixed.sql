-- ============================================================================
-- EVENTS TABLE - Event Sourcing Foundation (Fixed Version)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS events (
    ...
    user_id UUID,                            -- User who initiated (if applicable)
    ...
    -- Processing Status
    is_processed BOOLEAN DEFAULT FALSE,      -- Has Database Manager processed this?
...
CREATE INDEX IF NOT EXISTS idx_events_unprocessed ON events(is_processed) WHERE is_processed = FALSE;
...
COMMENT ON COLUMN events.is_processed IS 'Has Database Manager processed this event into state tables?';
