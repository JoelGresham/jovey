...
-- Version: 0.1.1 - Fixed ordering for RLS policies

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ============================================================================
-- USER PROFILES TABLE (Create FIRST - other tables reference this in RLS)
...
-- SETUP COMPLETE
-- ============================================================================
-- You should now see 4 tables in the Table Editor:
-- 1. user_profiles
-- 2. events
-- 3. products
-- 4. dealer_product_pricing
